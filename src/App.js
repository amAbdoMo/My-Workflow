    ...
    <main className={`app app-${theme}`}>
      ...
      <header className="topbar">
        ...
        <div className="topbar-actions">
          <button className="icon-action" type="button" aria-label="Settings" title="Settings" onClick={() => setActiveTab((current) => (current === "settings" ? "schedule" : "settings"))}>
          ...
          <button className="secondary-action" type="button" onClick={() => setShowClients(true)}>
            Clients
          </button>
